...
#!perl
#line 29
    eval 'exec C:\Users\USER\Downloads\karibu-groceries-web\perl\bin\perl.exe -S $0 ${1+"$@"}'
...
my $perlpath = 'C:\Users\USER\Downloads\karibu-groceries-web\perl\bin\perl.exe';
